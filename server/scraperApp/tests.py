...
class CourseTestCase(TestCase):
    ...
    def test_course_results_filter(self):
        ...
        response = self.client.get('http://server:8000/api/courses/', {'city': 'CITY_1'})
        self.assertEqual(len(response.data['results']), 1)
        for result in response.data['results']:
            self.assertIn('CITY_1', result['information']['city'])    

        response = self.client.get('http://server:8000/api/courses/', {'city': 'CITY_1', 'portal': 'Test Portal 1'})
        self.assertEqual(len(response.data['results']), 1)
        ...
        response = self.client.get('http://server:8000/api/courses/', {'city': 'CITY_1', 'portal': 'Test Portal 2'})
